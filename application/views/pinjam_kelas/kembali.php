                ...
                <div class="sparkline12-list" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                    <div class="sparkline12-hd">
                        <div class="main-sparkline12-hd">
                            <h1 class="text-center">Kembalikan Buku Kelas</h1>
                        </div>
                        <hr>
                    </div>
...
<h4 class="modal-title text-center"> PENGEMBALIAN BUKU</h4>
</div>
...
<div class="modal-footer">
    <div class="pull-right">
        <a href="<?= base_url('peminjaman/prosespinjam?kembali='.$pinjam->pinjam_id);?>">
