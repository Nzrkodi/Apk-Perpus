        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="sparkline13-list" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n">Data</span> Pencarian Buku Buku</h1><hr>
                            <?php if(!empty($this->session->flashdata())){ echo $this->session->flashdata('pesan');}?>
                        </div>  
                    </div>
                    <div class="sparkline13-graph">
                                ...
                                <?php $no=1;foreach($buku->result_array() as $isi){?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php }?>
                                            <a href="<?= base_url('data/bukudetail/'.$isi['id_buku']);?>">
                                            <button style="margin-top: 5px;" class="btn btn-block btn btn-success widget-btn-1"><i class="fa fa-eye"></i> Detail</button></a>
                                        </td>
                                        <td><?= $isi['isbn'];?></td>
                                        <td><?= $isi['title'];?></td>
                                        <td><?= $isi['penerbit'];?></td>
